...
NAME = 'SberAutoAcription: target event prediction'
...
DATA_FOLDER = Path('C:/Users/user/PycharmProjects/SBERautoScription/data',  'data')  # Path('data')
...
MODELS_FOLDER = Path('C:/Users/user/PycharmProjects/SBERautoScription/models', 'models')  # Path('models')
